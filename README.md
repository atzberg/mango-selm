...
For example notebooks and model scripts, see the [./examples folder](https://github.com/atzberg/mango-selm/tree/master/examples).  Also, see the documentation page and video tutorial at: http://doc.mango-selm.org/

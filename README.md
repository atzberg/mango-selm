...
**New Python/Juputer Notebooks for Modeling and Simulations*** SELM Models now can easily be set up using Python or Jupyter Notebooks.  See the webpage below for details and tutorial video.

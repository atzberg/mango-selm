 ...
 */
public class SELM_Integrator_LAMMPS_SHEAR1 extends SELM_Integrator
  ...
  public   String tagXML_numTimeSteps = "numTimeSteps";
  ...
  @Override
  public Object clone() {
    SELM_Integrator_LAMMPS_SHEAR1 Integrator_copy = new SELM_Integrator_LAMMPS_SHEAR1();
    ...
    Integrator_copy.numTimeSteps = this.numTimeSteps;
...
//    list[atz3D_Index_Points] = atz3D_Element_Points;
  ...
  public void exportToXML(BufferedWriter fid) {
    ...
    try {
      ...
      Atz_XML_Helper.writeXMLData(fid, tagXML_numTimeSteps, getNumberTimeSteps());
  ...
  public void XML_endElement(String uri, String localName, String qName, Atz_XML_SAX_DataHandler sourceHandler) throws SAXException {
    ...
    } else if (qName.equals(tagXML_numTimeSteps)) {

 ...
 */
public class TableModel_Integrator_Velocity_Verlet_Periodic_Lag extends TableModel_Integrator {
  ...
  public   String paramName_flagWriteSimulationData   = "Flag Write SELM Simulation Data";
  public   int paramIndex_flagWriteSimulationData     = -1;
  ...
  public   String paramName_saveSkipSimulationData    = "Save Skip";
  public   int paramIndex_saveSkipSimulationData      = -1;  

  public TableModel_Integrator_Velocity_Verlet_Periodic_Lag(SELM_Integrator_LAMMPS_SHEAR1 integrator) {
    setup(integrator, null);
  }
  
  public TableModel_Integrator_Velocity_Verlet_Periodic_Lag() {
    setup(null, null);
  }

  public TableModel_Integrator_Velocity_Verlet_Periodic_Lag(Atz_UnitsRef atz_unitsRef_in) {
  ...
  public final void setup(SELM_Integrator integrator_in, Atz_UnitsRef atz_unitsRef_in) {
    ...
    if (integrator == null) {
      integrator = new SELM_Integrator_Velocity_Verlet_Periodic_Lag();
    }
  ...
  public void setupFirstThirdColumns() {
    ...
    setValueAt(paramName_flagWriteSimulationData, i,0, NOT_EDITABLE);
    setValueAt(new TableData_EditorButton(), i,2, EDITABLE);
    paramIndex_flagWriteSimulationData = i;
    i++;
    ...
    setValueAt(paramName_saveSkipSimulationData, i,0, NOT_EDITABLE);
    setValueAt(new TableData_EditorButton(), i,2, EDITABLE);
    paramIndex_saveSkipSimulationData = i;
    i++;
  ...
  public void setupTableDataPrototypes() {
    ...
    data[paramIndex_saveSkipSimulationData][colValue]            = (Integer) 0;
    dataEditable[paramIndex_saveSkipSimulationData][colValue]    = EDITABLE;
  ...
  public void setFromIntegratorData() {
    ...
    SELM_Integrator_Velocity_Verlet_Periodic_Lag integratorData
      = (SELM_Integrator_Velocity_Verlet_Periodic_Lag)integrator;
    ...
    if (integrator !=null) {
      ...
      data[paramIndex_saveSkipSimulationData][colValue]         = (Integer)integratorData.getSaveSkipSimulationData();
      dataEditable[paramIndex_saveSkipSimulationData][colValue] = EDITABLE;
  ...
  public void setIntegratorDataFromModel() {
   ...
   SELM_Integrator_Velocity_Verlet_Periodic_Lag integratorData
    ...
    integratorData.setSaveSkipSimulationData((Integer)getValueAt(paramIndex_saveSkipSimulationData,colValue));

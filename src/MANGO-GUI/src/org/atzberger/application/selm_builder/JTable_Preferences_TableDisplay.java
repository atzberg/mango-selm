 ...
 */
public class JTable_Preferences_TableDisplay extends JTable_Properties1_Default {

  public JTable_Preferences_TableDisplay() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Preferences_TableDisplay(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Preferences_TableDisplay(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);
  ...
  public void setApplSharedData(application_SharedData applSharedData_in) {
    ...
    TableModel_Preferences_TableDisplay model = (TableModel_Preferences_TableDisplay) this.getModel();

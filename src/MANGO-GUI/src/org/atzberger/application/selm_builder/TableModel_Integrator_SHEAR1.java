 ...
 */
public class TableModel_Integrator_SHEAR1 extends TableModel_Integrator {
  ...
  public TableModel_Integrator_SHEAR1(SELM_Integrator_SHEAR1 integrator) {
    setup(integrator, null);
  }
  
  public TableModel_Integrator_SHEAR1() {
    setup(null, null);
  }

  public TableModel_Integrator_SHEAR1(Atz_UnitsRef atz_unitsRef_in) {
  ...
  public final void setup(SELM_Integrator integrator_in, Atz_UnitsRef atz_unitsRef_in) {
    ...
    if (integrator == null) {
      integrator = new SELM_Integrator_SHEAR1();
    }
  ...
  public void setFromIntegratorData() {
    ...
    SELM_Integrator_SHEAR1 integratorData
      = (SELM_Integrator_SHEAR1)integrator;

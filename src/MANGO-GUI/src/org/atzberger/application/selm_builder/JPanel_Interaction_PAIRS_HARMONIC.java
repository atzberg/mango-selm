 ...
 */
public class JPanel_Interaction_PAIRS_HARMONIC extends JPanel_Interaction implements SELM_InteractionRenderView {
  ...
  SELM_Interaction_PAIRS_HARMONIC interaction_on_click;
  ...
  public JPanel_Interaction_PAIRS_HARMONIC(application_SharedData applSharedData_in) {
  ...
  //public JPanel_Interaction_PAIRS_HARMONIC() {
  //  initComponents();
  //  modifyComponents();
 // }
  ...
  void modifyComponents() {
    ...
    private void initComponents() {
        ...
        jLabel_Stiffness = new javax.swing.JLabel();
        jFormattedTextField_Stiffness = new javax.swing.JFormattedTextField();
        jLabel_I1 = new javax.swing.JLabel();
        jLabel_val_I1 = new javax.swing.JLabel();
        jToggleButton_Adding_Pairs = new javax.swing.JToggleButton();
        jToggleButton_Removing_Pairs = new javax.swing.JToggleButton();
        jLabel_val_I2 = new javax.swing.JLabel();
        jLabel_I2 = new javax.swing.JLabel();
        jFormattedTextField_RestLength = new javax.swing.JFormattedTextField();
        jLabel_RestLength = new javax.swing.JLabel();
        jPanel_tableHolder = new javax.swing.JPanel();
        jScrollPane_Interaction = new javax.swing.JScrollPane();
        jTable_Interaction = new org.atzberger.application.selm_builder.JTable_Interaction_PAIRS_HARMONIC();

        setName("PAIRS_HARMONIC"); // NOI18N

        jPanel_Controls.setName("jPanel_Controls"); // NOI18N

        jLabel1.setName("jLabel1"); // NOI18N

        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.atzberger.application.selm_builder.application_Main.class).getContext().getResourceMap(JPanel_Interaction_PAIRS_HARMONIC.class);
        jLabel_Stiffness.setText(resourceMap.getString("jLabel_Stiffness.text")); // NOI18N
        jLabel_Stiffness.setName("jLabel_Stiffness"); // NOI18N

        jFormattedTextField_Stiffness.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jFormattedTextField_Stiffness.setName("jFormattedTextField_Stiffness"); // NOI18N
        jFormattedTextField_Stiffness.setValue(new Double(0.0));
        jFormattedTextField_Stiffness.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jFormattedTextField_StiffnessKeyPressed(evt);
            }
        });
        ...
        jLabel_val_I1.setText(resourceMap.getString("jLabel_val_I1.text")); // NOI18N
        jLabel_val_I1.setName("jLabel_val_I1"); // NOI18N
        ...
        jLabel_val_I2.setText(resourceMap.getString("jLabel_val_I2.text")); // NOI18N
        jLabel_val_I2.setName("jLabel_val_I2"); // NOI18N

        jLabel_I2.setText(resourceMap.getString("jLabel_I2.text")); // NOI18N
        jLabel_I2.setName("jLabel_I2"); // NOI18N

        jFormattedTextField_RestLength.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jFormattedTextField_RestLength.setName("jFormattedTextField_RestLength"); // NOI18N
        jFormattedTextField_RestLength.setValue(new Double(0.0));

        jLabel_RestLength.setText(resourceMap.getString("jLabel_RestLength.text")); // NOI18N
        jLabel_RestLength.setName("jLabel_RestLength"); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ControlsLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                        .addComponent(jLabel_Stiffness)
                        .addGap(24, 24, 24)
                        .addComponent(jFormattedTextField_Stiffness, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                        .addComponent(jLabel_RestLength)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jFormattedTextField_RestLength, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                        .addComponent(jLabel_I1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel_val_I1))
                    .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                        .addComponent(jLabel_I2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabel_val_I2)))
                ...
                .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jToggleButton_Adding_Pairs, javax.swing.GroupLayout.DEFAULT_SIZE, 153, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                    .addGap(67, 67, 67)
                ...
                .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                        .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel_Stiffness)
                            .addComponent(jFormattedTextField_Stiffness, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel_I1)
                            .addComponent(jLabel_val_I1))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jFormattedTextField_RestLength, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel_I2)
                                .addComponent(jLabel_val_I2))
                            .addComponent(jLabel_RestLength))))
        ...
        jPanel_tableHolderLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_tableHolderLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane_Interaction, javax.swing.GroupLayout.DEFAULT_SIZE, 548, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel_tableHolderLayout.setVerticalGroup(
            jPanel_tableHolderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel_tableHolderLayout.createSequentialGroup()
                .addComponent(jScrollPane_Interaction, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel_Controls, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jPanel_tableHolder, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    }// </editor-fold>//GEN-END:initComponents

    private void jFormattedTextField_StiffnessKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jFormattedTextField_StiffnessKeyPressed
      // TODO add your handling code here:
}//GEN-LAST:event_jFormattedTextField_StiffnessKeyPressed
  ...
  private void jToggleButton_AddingPairs_interface_Selection(MouseEvent e) {
    ...
    //System.out.println("Adding Pairs !!!!!!!!!!!!! : Mouse clicked (# of clicks: "
    //        + e.getClickCount() + ")" + e);
    ...
    if (controlPtsSelectedList.length >= 1) {
      ...
      jLabel_val_I1.setText(nameTrunc + ":" + Integer.toString(I1));
      jLabel_val_I1.setForeground(Color.green);
    }
    ...
    if (controlPtsSelectedList.length >= 2) {
      ...
      SELM_Interaction_PAIRS_HARMONIC interaction_PAIRS_HARMONIC
        = (SELM_Interaction_PAIRS_HARMONIC) model.getInteractionDataFromModel();

      double stiffnessK = Double.parseDouble(jFormattedTextField_Stiffness.getText());
      double restLength = Double.parseDouble(jFormattedTextField_RestLength.getText());
      ...
      for (int k = 0; k < N_new; k++) {
        ...
        jLabel_val_I2.setText(nameTrunc + ":" + Integer.toString(I2));
        jLabel_val_I2.setForeground(Color.blue);

        //System.out.println("Adding to interaction : I1 = " + lagrangianI1.LagrangianName + ":" + I1
        //                                       + "; I2 = " + lagrangianI2.LagrangianName + ":" + I2);

        interaction_PAIRS_HARMONIC.addPair(lagrangianI1, I1, lagrangianI2, I2, stiffnessK, restLength);

      }

      jLabel_val_I1.setForeground(Color.black);
      jLabel_val_I2.setForeground(Color.black);

      model.setFromInteractionData(interaction_PAIRS_HARMONIC);
  ...
  private void jToggleButton_RemovingPairs_interface_Selection(MouseEvent e) {
    ...
    if (controlPtsSelectedList.length >= 1) {
      ...
      nameTrunc    = truncStr(lagrangianI1.LagrangianName, STR_LAGRANGIAN_NAME_TRUNC_SIZE);
      jLabel_val_I1.setText(nameTrunc + ":" + Integer.toString(I1));
      jLabel_val_I1.setForeground(Color.red);
    }
    ...
    if (controlPtsSelectedList.length >= 2) {
      ...
      for (int k = 0; k < N_new; k++) {
        ...
        interaction_PAIRS_HARMONIC.removePair(lagrangianI1, I1, lagrangianI2, I2);
  ...
  public void interface_Selection_mouseClicked(MouseEvent e) {
    ...
    SELM_Interaction_PAIRS_HARMONIC interaction = (SELM_Interaction_PAIRS_HARMONIC)this.getData();
    ...
    for (k = 0; k < lagrangianList.length; k++) {
      ...
      /* only consider CONTROL_PTS_BASIC1 */
      if (SELM_Lagrangian_CONTROL_PTS_BASIC1.class.isInstance(lagrangianList[k])) {
        
        SELM_Lagrangian_CONTROL_PTS_BASIC1 lagrangian_CONTROL_PTS_BASIC1
          = (SELM_Lagrangian_CONTROL_PTS_BASIC1)lagrangianList[k];

        if (lagrangian_CONTROL_PTS_BASIC1.isVisible()) {
          ...
          atz3D_elements = lagrangian_CONTROL_PTS_BASIC1.getAtz3DElementRepresentation();
          atz3D_points   = (Atz3D_Element_Points) atz3D_elements[lagrangian_CONTROL_PTS_BASIC1.atz3D_Index_Points];
          ...
          if ((dist_sq < dist_sq_min) || (dist_sq_min < 0)) {
            dist_sq_min    = dist_sq;
            keyPt_min      = keyPt;
            lagrangian_min = lagrangian_CONTROL_PTS_BASIC1;
          }

        } /* end check is visible */

      } /* end check CONTROL_PTS_BASIC1 */
  ...
  public void renderToModel3D(Atz3D_Model model3D) {
    ...
    for (k = 0; k < N; k++) {
      ptsX = ((SELM_Lagrangian_CONTROL_PTS_BASIC1)(lagrangianSelectedList[k])).getPtsX();
  ...
  String truncStr(String str, int size) {
    ...
    private javax.swing.JFormattedTextField jFormattedTextField_RestLength;
    private javax.swing.JFormattedTextField jFormattedTextField_Stiffness;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel_I1;
    private javax.swing.JLabel jLabel_I2;
    private javax.swing.JLabel jLabel_RestLength;
    private javax.swing.JLabel jLabel_Stiffness;
    private javax.swing.JLabel jLabel_val_I1;
    private javax.swing.JLabel jLabel_val_I2;

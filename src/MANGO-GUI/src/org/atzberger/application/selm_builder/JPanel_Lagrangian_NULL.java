 ...
 */
public class JPanel_Lagrangian_NULL extends JPanel_Lagrangian implements SELM_LagrangianRenderView {

    String interfaceModeStr = "";

    public JPanel_Lagrangian_NULL(application_SharedData applSharedData_in) {
      super();

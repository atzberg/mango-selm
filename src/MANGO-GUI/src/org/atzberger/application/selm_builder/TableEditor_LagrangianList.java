 ...
 */
public class TableEditor_LagrangianList extends AbstractCellEditor
  ...
  public TableEditor_LagrangianList() {
  ...
  public Component getTableCellEditorComponent(JTable table,
    ...
    if (flagAllowEdits) {
      ...
      int n = JOptionPane.showOptionDialog(table.getParent(),
              "Use the 'Lagrangian DOF' tab to edit this list.",
              "Edit Lagrangian List",

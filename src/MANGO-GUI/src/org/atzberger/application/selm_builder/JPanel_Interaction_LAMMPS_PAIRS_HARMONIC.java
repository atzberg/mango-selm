 ...
 */
public class JPanel_Interaction_LAMMPS_PAIRS_HARMONIC extends JPanel_Interaction implements SELM_InteractionRenderView {
  ...
  SELM_Interaction_LAMMPS_PAIRS_HARMONIC interaction_on_click;
  ...
  public JPanel_Interaction_LAMMPS_PAIRS_HARMONIC(application_SharedData applSharedData_in) {
  ...
  //public JPanel_Interaction_LAMMPS_PAIRS_HARMONIC() {
  //  initComponents();
  //  modifyComponents();
 // }
  ...
  public void setData(SELM_Interaction interaction) {
    ...
    ((TableModel_Interaction_LAMMPS_PAIRS_HARMONIC)(jTable_Interaction.getModel())).setFromInteractionData(interaction);
  ...
  public SELM_Interaction getData() {
    ...
    interaction = ((TableModel_Interaction_LAMMPS_PAIRS_HARMONIC)(jTable_Interaction.getModel())).getInteractionDataFromModel();
  ...
  void modifyComponents() {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.atzberger.application.selm_builder.application_Main.class).getContext().getResourceMap(JPanel_Interaction_LAMMPS_PAIRS_HARMONIC.class);
        ...
        jPanel_ControlsLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ControlsLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(jToggleButton_Adding_Pairs, javax.swing.GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel_ControlsLayout.createSequentialGroup()
                    .addGap(67, 67, 67)
        ...
        jTable_Interaction.setModel(new TableModel_Interaction_LAMMPS_PAIRS_HARMONIC());
        ...
        jPanel_tableHolderLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_tableHolderLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane_Interaction, javax.swing.GroupLayout.DEFAULT_SIZE, 509, Short.MAX_VALUE)
                .addContainerGap())
        );
  ...
  private void jToggleButton_AddingPairs_interface_Selection(MouseEvent e) {
    ...
    if (controlPtsSelectedList.length >= 2) {
       ...
       */
      TableModel_Interaction_LAMMPS_PAIRS_HARMONIC model
        = (TableModel_Interaction_LAMMPS_PAIRS_HARMONIC) jTable_Interaction.getModel();

      SELM_Interaction_LAMMPS_PAIRS_HARMONIC Interaction_LAMMPS_PAIRS_HARMONIC
        = (SELM_Interaction_LAMMPS_PAIRS_HARMONIC) model.getInteractionDataFromModel();
      ...
      for (int k = 0; k < N_new; k++) {
        ...
        Interaction_LAMMPS_PAIRS_HARMONIC.addPair(lagrangianI1, I1, lagrangianI2, I2, stiffnessK, restLength);
      ...
      model.setFromInteractionData(Interaction_LAMMPS_PAIRS_HARMONIC);
  ...
  private void jToggleButton_RemovingPairs_interface_Selection(MouseEvent e) {
    ...
    if (controlPtsSelectedList.length >= 2) {
      ...
      for (int k = 0; k < N_new; k++) {
        ...
        Interaction_LAMMPS_PAIRS_HARMONIC.removePair(lagrangianI1, I1, lagrangianI2, I2);
  ...
  public void interface_Selection_mouseClicked(MouseEvent e) {
    ...
    SELM_Interaction_LAMMPS_PAIRS_HARMONIC interaction = (SELM_Interaction_LAMMPS_PAIRS_HARMONIC)this.getData();

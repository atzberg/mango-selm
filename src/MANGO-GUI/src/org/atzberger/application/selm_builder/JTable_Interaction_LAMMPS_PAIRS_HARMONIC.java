 ...
 */
public class JTable_Interaction_LAMMPS_PAIRS_HARMONIC extends JTable_Interaction {

  public JTable_Interaction_LAMMPS_PAIRS_HARMONIC() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_PAIRS_HARMONIC(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_PAIRS_HARMONIC(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);

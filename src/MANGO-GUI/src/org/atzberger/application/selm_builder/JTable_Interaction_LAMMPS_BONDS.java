 ...
 */
public class JTable_Interaction_LAMMPS_BONDS extends JTable_Interaction {

  public JTable_Interaction_LAMMPS_BONDS() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_BONDS(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_BONDS(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);

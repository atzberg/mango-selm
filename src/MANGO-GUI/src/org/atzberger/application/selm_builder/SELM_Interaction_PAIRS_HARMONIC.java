 ...
 */
public class SELM_Interaction_PAIRS_HARMONIC extends SELM_Interaction implements Atz_DataChangeListener, Atz_XML_SAX_DataHandlerInterface {
  ...
  public SELM_Interaction_PAIRS_HARMONIC() {
  ...
  @Override
  public SELM_Interaction_PAIRS_HARMONIC clone() {
    SELM_Interaction_PAIRS_HARMONIC interaction_copy = new SELM_Interaction_PAIRS_HARMONIC();
  ...
  public Atz3D_Element[] getAtz3DElementRepresentation() {
    ...
    double[]        X1, X2;
    double[]        ptsX1, ptsX2;
    SELM_Lagrangian_CONTROL_PTS_BASIC1 lagrangianI1, lagrangianI2;
    ...
    for (int k = 0; k < N; k++) {
      ...
      lagrangianI1 = (SELM_Lagrangian_CONTROL_PTS_BASIC1) pairList_lagrangianI1[k];
      I1           = pairList_ptI1[k];

      lagrangianI2 = (SELM_Lagrangian_CONTROL_PTS_BASIC1) pairList_lagrangianI2[k];
      I2           = pairList_ptI2[k];
  ...
  public void handleDataChange(Atz_DataChangeEvent e) {
    ...
    if (SELM_Lagrangian_CONTROL_PTS_BASIC1.class.isInstance(e.getSource())) {

      SELM_Lagrangian_CONTROL_PTS_BASIC1 source = (SELM_Lagrangian_CONTROL_PTS_BASIC1) e.getSource();
      ...
      if (source.DATA_CHANGE_REMOVE_PT.equals(e.getDataChangeType())) {
        ...
        SELM_Lagrangian_CONTROL_PTS_BASIC1 lagrangian     = (SELM_Lagrangian_CONTROL_PTS_BASIC1) extras.get("lagrangian");
    ...
    } /* SELM_Lagrangian_CONTROL_PTS_BASIC1 */

 ...
 */
public class JDialog_Edit_EulerianList extends JDialog_Edit implements TableModelListener {
  ...
  public JDialog_Edit_EulerianList(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    //modifyComponents();
  }

  public JDialog_Edit_EulerianList() {
    initComponents();
    //modifyComponents();
  ...
  private void initComponents() {
    ...
    jTable_InteractionList = new JTable_Properties1_Default();
    ...
    jTable_InteractionList.setModel(new TableModel_InteractionList());
    jTable_InteractionList.getModel().addTableModelListener(this);
    jTable_InteractionList.setName("jTable_InteractionList"); // NOI18N
    jScrollPane1.setViewportView(jTable_InteractionList);
  ...
  private void jButton_OKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_OKActionPerformed
    ...
    TableCellEditor editor = jTable_InteractionList.getCellEditor();
    if (editor != null) {
  ...
  public static void main(String args[]) {
    java.awt.EventQueue.invokeLater(new Runnable() {
      ...
      public void run() {
        JDialog_Edit_EulerianList dialog = new JDialog_Edit_EulerianList(new javax.swing.JFrame(), true);
  ...
  public void setDataValue(Object dataValue, String dataName, String dataType) {
    ...
    tableModel_InteractionList = (TableModel_InteractionList) jTable_InteractionList.getModel();
  ...
  public void setVisible(boolean flag) {
    ...
    if (flag == false) {
      ...
      jTable_InteractionList.clearSelection();
    }

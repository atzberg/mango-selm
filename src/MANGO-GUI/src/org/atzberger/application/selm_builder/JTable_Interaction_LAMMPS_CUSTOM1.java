 ...
 */
public class JTable_Interaction_LAMMPS_CUSTOM1 extends JTable_Interaction {

  public JTable_Interaction_LAMMPS_CUSTOM1() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_CUSTOM1(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_CUSTOM1(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);
  ...
  public void deleteParamDataSelectedRows() {

    int[] selectedRows = getSelectedRows();

    /* stop any editing before deleting the row */
    getCellEditor().stopCellEditing();

    /* delete the rows */
    ((TableModel_Interaction_LAMMPS_CUSTOM1)getModel()).deleteParamDataSelectedRows(selectedRows);
  }

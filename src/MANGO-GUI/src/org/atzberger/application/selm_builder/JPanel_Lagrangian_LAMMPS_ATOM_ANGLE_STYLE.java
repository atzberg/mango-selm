 ...
 */
public class JPanel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE extends JPanel_Lagrangian
    ...
    SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE lagrangian_on_click;
    ...
    public JPanel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE(application_SharedData applSharedData_in) {
      super();
    ...
    /** Creates new form JPanel_Lagrangian_LAMMPS_ATOM_angle_style */
    public JPanel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE() {
      super();
      initComponents();
  ...
  private void initComponents() {
    ...
    setName("LAMMPS_ATOM_ANGLE_STYLE"); // NOI18N
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.atzberger.application.selm_builder.application_Main.class).getContext().getResourceMap(JPanel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE.class);
    ...
    jTable_Lagrangian.setModel(new org.atzberger.application.selm_builder.TableModel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE());
    ...
    layout.setHorizontalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addComponent(jScrollPane_Lagrangian, javax.swing.GroupLayout.DEFAULT_SIZE, 574, Short.MAX_VALUE)
          .addGroup(layout.createSequentialGroup()
    ...
    layout.setVerticalGroup(
      ...
      .addGroup(layout.createSequentialGroup()
        ...
        .addComponent(jScrollPane_Lagrangian, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addContainerGap())
    );
  ...
  void disconnectInterface() {
    ...
    private void jToggleButton_Add_PointsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton_Add_PointsActionPerformed
      ...
      SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE lagrangian = (SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE)this.getData();

      /* add point at the current clicked location */     
      double[] newPtsX   = renderModelView.camera.cameraVRP.clone();

      int[] typeID = (lagrangian.getTypeID()); /* assume all IDs are the same for this object */

      lagrangian.addPoints(newPtsX, null, null, typeID, null);
  ...
  public void setData(SELM_Lagrangian lagrangian) {
    ...
    ((TableModel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE)(jTable_Lagrangian.getModel())).setFromLagrangianData(lagrangian);
  ...
  public SELM_Lagrangian getData() {
    ...
    lagrangian = ((TableModel_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE)(jTable_Lagrangian.getModel())).getLagrangianDataFromModel();
  ...
  public void interface_Move_Point_translation_mouseDragged(MouseEvent e, int dirFlag) {
    ...
    if (flagMouseDraggedOn == 0) {
      ...
      lagrangian_on_click = (SELM_Lagrangian_LAMMPS_ATOM_ANGLE_STYLE) (this.getData()).clone();

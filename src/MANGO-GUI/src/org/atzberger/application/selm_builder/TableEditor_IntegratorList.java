 ...
 */
public class TableEditor_IntegratorList extends AbstractCellEditor
        implements TableCellEditor, PropertyChangeListener,
        ActionListener {

  final static boolean DEBUG = false;

  TableData_IntegratorList  dataValue;
  ...
  public TableEditor_IntegratorList() {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (JBUTTON_EDIT.equals(e.getActionCommand())) {
      ...
      dataValue = (TableData_IntegratorList) dialog.getDataValue();
    }
  ...
  public Component getTableCellEditorComponent(JTable table,
    ...
    dataValue = (TableData_IntegratorList)value;

    //dataValue.flagDisplayType = TableData_IntegratorList.DISPLAY_NAME_LIST;

    switch (dataValue.flagDisplayType) {

      case TableData_IntegratorList.DISPLAY_MULTIPLE_CHOICE:

        jComboBox.removeAllItems();
        for (int k = 0; k < dataValue.integratorList.length; k++) {
          jComboBox.addItem(dataValue.integratorList[k].IntegratorName);
        }

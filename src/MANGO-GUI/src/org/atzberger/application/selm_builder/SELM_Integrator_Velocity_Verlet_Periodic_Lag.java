 ...
 */
public class SELM_Integrator_Velocity_Verlet_Periodic_Lag extends SELM_Integrator
  ...
  private int      flagWriteSimulationData = 1;
  private int      saveSkipSimulationData  = 1;
  ...
  /* other */
  public   String tagXML_flagWriteSimulationData = "flagWriteSimulationData";
  public   String tagXML_saveSkipSimulationData  = "saveSkipSimulationData";
  
  public   String tagXML_flagComputeFluidStatistics = "flagComputeFluidStatistics";
  
  SELM_Integrator_Velocity_Verlet_Periodic_Lag() {
    super();
  ...
  @Override
  public Object clone() {
    SELM_Integrator_Velocity_Verlet_Periodic_Lag Integrator_copy = new SELM_Integrator_Velocity_Verlet_Periodic_Lag();
    ...
    Integrator_copy.saveSkipSimulationData  = this.saveSkipSimulationData;
  ...
  public void setFlagWriteSimulationData(Boolean value) {
    if (value == true) {
      flagWriteSimulationData = 1;
    } else {
  ...
  public void setWriteSimulationData(int value) {
    flagWriteSimulationData = value;
  }
...
//  }
  ...
  public void setSaveSkipSimulationData(int value) {
    saveSkipSimulationData = value;
  }
...
//  }
  ...
  public int getFlagWriteSimulationDataAsInt() {
    return flagWriteSimulationData;
  }
...
//  }
  ...
  public int getSaveSkipSimulationData() {
    return saveSkipSimulationData;
  }
...
//    list[atz3D_Index_Points] = atz3D_Element_Points;
  ...
  public void exportToXML(BufferedWriter fid) {
    ...
    try {
      ...
      Atz_XML_Helper.writeXMLData(fid, "lagNumberTimeSteps",  1);
      
      Atz_XML_Helper.writeXMLData(fid, tagXML_flagWriteSimulationData,  getFlagWriteSimulationDataAsInt());                         
      Atz_XML_Helper.writeXMLData(fid, tagXML_saveSkipSimulationData,   getSaveSkipSimulationData());      
      
      Atz_XML_Helper.writeXMLData(fid, "flagComputeFluidStatistics", 0);
...
//      setShearVelDir(Integer.parseInt(xmlAttributes.getValue("value")));
    } else if (qName.equals(tagXML_saveSkipSimulationData)) {
      setSaveSkipSimulationData(Integer.parseInt(xmlAttributes.getValue("value")));
    }

 ...
 */
public class JPanel_Helper_CouplingOperator_GenericTable extends JPanel_CouplingOperator {

  public JPanel_Helper_CouplingOperator_GenericTable() {
    this(null); /* call constructor with null as model */
  }
          
  public JPanel_Helper_CouplingOperator_GenericTable(TableModel_CouplingOperator model) {
    initComponents();
    modifyComponents();

    if (model == null) {
      setTableModel(new org.atzberger.application.selm_builder.TableModel_CouplingOperator()); /* default model to use */
    } else {
      setTableModel(model);
    }
  ...
  public void jTable_CouplingOperator_tableChanged(TableModelEvent e)  {
    //System.out.println("jTable_CouplingOperator changed event" + e);

    fireCouplingOperatorChanged();

  }

  
  public void fireCouplingOperatorChanged() {

    JPanel jPanel_parent = (JPanel) this.getParent();

    if (jPanel_parent != null) {
      jPanel_parent.firePropertyChange("CHANGED_CouplingOperator_DATA", 0, 1);
    }

  }

  public void setTableModel(TableModel_CouplingOperator model) {
    ...
    model.addTableModelListener(new TableModelListener() {
      public void tableChanged(TableModelEvent e)  {
        jTable_CouplingOperator_tableChanged(e);
      }
    });
  ...
  @Override
  public void setData(SELM_CouplingOperator CouplingOperator) {

    TableModel_CouplingOperator model = (TableModel_CouplingOperator) jTable.getModel();

    /* perform the generic set */
    model.setFromCouplingOpData(CouplingOperator);
  ...
  public SELM_CouplingOperator getData() {
    ...
    SELM_CouplingOperator CouplingOperator;

    TableModel_CouplingOperator model = (TableModel_CouplingOperator) jTable.getModel();
    
    /* perform the generic get */
    CouplingOperator = model.getCouplingOpDataFromModel();
  ...
  public String getRenderTag() {
    return atz3D_RENDER_TAG_COUPLING_OP_ANNOTATION;  /* indicate this is annotation */
  }

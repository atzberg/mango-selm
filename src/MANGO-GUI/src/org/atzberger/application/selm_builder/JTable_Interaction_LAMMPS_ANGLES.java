 ...
 */
public class JTable_Interaction_LAMMPS_ANGLES extends JTable_Interaction {

  public JTable_Interaction_LAMMPS_ANGLES() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_ANGLES(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_ANGLES(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);

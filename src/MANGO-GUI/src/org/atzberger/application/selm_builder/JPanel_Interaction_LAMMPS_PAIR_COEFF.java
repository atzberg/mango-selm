 ...
 */
public class JPanel_Interaction_LAMMPS_PAIR_COEFF extends JPanel_Interaction implements SELM_InteractionRenderView {
  ...
  SELM_Interaction_LAMMPS_PAIR_COEFF interaction_on_click;
  ...
  public JPanel_Interaction_LAMMPS_PAIR_COEFF(application_SharedData applSharedData_in) {
 ...
 // }
  ...
  public void setData(SELM_Interaction interaction) {
    ...
    ((TableModel_Interaction_LAMMPS_PAIR_COEFF)(jTable_Interaction.getModel())).setFromInteractionData(interaction);
  ...
  public SELM_Interaction getData() {
    ...
    interaction = ((TableModel_Interaction_LAMMPS_PAIR_COEFF)(jTable_Interaction.getModel())).getInteractionDataFromModel();
  ...
  private void initComponents() {
    ...
    jTable_Interaction = new org.atzberger.application.selm_builder.JTable_Interaction_LAMMPS_PAIR_COEFF();

    setName("LAMMPS_PAIR_COEFF"); // NOI18N

    jPanel_Controls.setName("jPanel_Controls"); // NOI18N

    jLabel1.setName("jLabel1"); // NOI18N

    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(org.atzberger.application.selm_builder.application_Main.class).getContext().getResourceMap(JPanel_Interaction_LAMMPS_PAIR_COEFF.class);
    ...
    jPanel_ControlsLayout.setHorizontalGroup(
      ...
      .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel_ControlsLayout.createSequentialGroup()
        ...
        .addComponent(jFormattedTextField_Stiffness, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addGroup(jPanel_ControlsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(jPanel_ControlsLayout.createSequentialGroup()
            ...
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(jLabel_val_typeI1))
          .addGroup(jPanel_ControlsLayout.createSequentialGroup()
            .addComponent(jLabel_I2)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(jLabel_val_typeI2)))
    ...
    jTable_Interaction.setModel(new org.atzberger.application.selm_builder.TableModel_Interaction_LAMMPS_PAIR_COEFF());
    ...
    jPanel_tableHolderLayout.setHorizontalGroup(
      ...
      .addGroup(jPanel_tableHolderLayout.createSequentialGroup()
        .addContainerGap()
        .addComponent(jScrollPane_Interaction, javax.swing.GroupLayout.DEFAULT_SIZE, 572, Short.MAX_VALUE)
        .addContainerGap())
    );
  ...
  private void jToggleButton_AddingPairs_interface_Selection(MouseEvent e) {
    ...
    if (controlPtsSelectedList.length >= 2) {
       ...
       */
      TableModel_Interaction_LAMMPS_PAIR_COEFF model
        = (TableModel_Interaction_LAMMPS_PAIR_COEFF) jTable_Interaction.getModel();

      SELM_Interaction_LAMMPS_PAIR_COEFF Interaction_LAMMPS_PAIRS_HARMONIC
        = (SELM_Interaction_LAMMPS_PAIR_COEFF) model.getInteractionDataFromModel();
      ...
      for (int k = 0; k < N_new; k++) {
        ...
        Interaction_LAMMPS_PAIRS_HARMONIC.addTypePair(lagrangianI1, typeI1, lagrangianI2, typeI2, coefficient);
  ...
  private void jToggleButton_RemovingPairs_interface_Selection(MouseEvent e) {
    ...
    if (controlPtsSelectedList.length >= 2) {
      ...
      for (int k = 0; k < N_new; k++) {
        ...
        Interaction_LAMMPS_PAIRS_HARMONIC.removeTypePair(lagrangianI1, typeI1, lagrangianI2, typeI2);
  ...
  public void interface_Selection_mouseClicked(MouseEvent e) {
    ...
    SELM_Interaction_LAMMPS_PAIR_COEFF interaction = (SELM_Interaction_LAMMPS_PAIR_COEFF)this.getData();

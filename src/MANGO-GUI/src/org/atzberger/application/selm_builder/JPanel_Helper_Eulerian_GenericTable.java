 ...
 */
public class JPanel_Helper_Eulerian_GenericTable extends JPanel_Eulerian {

  public JPanel_Helper_Eulerian_GenericTable() {
    this(null); /* call constructor with null as model */
  }
          
  public JPanel_Helper_Eulerian_GenericTable(TableModel_Eulerian model) {
    initComponents();
    modifyComponents();

    if (model == null) {
      setTableModel(new org.atzberger.application.selm_builder.TableModel_Eulerian()); /* default model to use */
    } else {
      setTableModel(model);
    }
  ...
  public void setTableModel(TableModel_Eulerian model) {
  ...
  public void setData(SELM_Eulerian Eulerian) {
    ...
    TableModel_Eulerian model = (TableModel_Eulerian) jTable.getModel();

    /* perform the generic set */
    model.setFromEulerianData(Eulerian);
  ...
  public SELM_Eulerian getData() {
    ...
    Eulerian = model.getEulerianDataFromModel();
  ...
  public String getRenderTag() {
    return atz3D_RENDER_TAG_EULERIAN_ANNOTATION;  /* indicate this is annotation */
  }

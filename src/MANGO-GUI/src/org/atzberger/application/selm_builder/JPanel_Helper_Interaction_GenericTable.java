 ...
 */
public class JPanel_Helper_Interaction_GenericTable extends JPanel_Interaction {

  public JPanel_Helper_Interaction_GenericTable() {
    this(null); /* call constructor with null as model */
  }
          
  public JPanel_Helper_Interaction_GenericTable(TableModel_Interaction model) {       
    initComponents();
    modifyComponents();

    if (model == null) {
      setTableModel(new org.atzberger.application.selm_builder.TableModel_Interaction()); /* default model to use */
    } else {
      setTableModel(model);
    }
  ...
  public void setTableModel(TableModel_Interaction model) {
  ...
  public void setData(SELM_Interaction interaction) {
    ...
    TableModel_Interaction model = (TableModel_Interaction) jTable.getModel();

    /* perform the generic set */
    model.setFromInteractionData(interaction);
  ...
  public SELM_Interaction getData() {
    ...
    interaction = model.getInteractionDataFromModel();

 ...
 */
public class JTable_Lagrangian_ControlPts_BASIC1 extends JTable_Properties1_Default {

  public JTable_Lagrangian_ControlPts_BASIC1() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Lagrangian_ControlPts_BASIC1(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Lagrangian_ControlPts_BASIC1(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);

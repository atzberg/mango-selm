 ...
 */
public class TableEditor_CouplingOperatorList extends AbstractCellEditor
  ...
  public TableEditor_CouplingOperatorList() {
  ...
  public Component getTableCellEditorComponent(JTable table,
    ...
    boolean flagAllowEdits = false;  /* over-rides features to turn off editing for this data type in cell */
    ...
    if (flagAllowEdits) {      
      ...
      int n = JOptionPane.showOptionDialog(table.getParent(),
              "Use the 'Coupling Operators' tab to edit this list.",

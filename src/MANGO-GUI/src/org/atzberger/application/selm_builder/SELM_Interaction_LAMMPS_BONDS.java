 ...
 */
public class SELM_Interaction_LAMMPS_BONDS extends SELM_Interaction implements SELM_InteractionInterface_LAMMPS_BONDS, Atz_DataChangeListener, Atz_XML_SAX_DataHandlerInterface {
  ...
  private int             bondTypeID        = -1;
  private String          bondStyle         = "harmonic";  
  private String          bondCoeffsStr     = "1.0 1.0";
  
  //private String          bondStyleList[]   = new String[] {"harmonic","","",""};
  ...
  public static String tagXML_bondTypeID            = "bondTypeID";  
  public static String tagXML_bondStyle             = "bondStyle";
  public static String tagXML_bondCoeffs            = "bondCoeffs";

  public static String tagXML_flagVisible           = "flagVisible";
  public static String tagXML_plotColor             = "plotColor";
 
  public SELM_Interaction_LAMMPS_BONDS() {
  ...
  public void setBondStyle(String bondStyle_in) {
    bondStyle = bondStyle_in;
  }

  public void setBondTypeID(int bondTypeID_in) {
    bondTypeID = bondTypeID_in;
  }
  
  public void setBondCoeffsStr(String bondCoeffs_in) {
    bondCoeffsStr = bondCoeffs_in;
  }
    ...
    if (flagNewPair) {
      ...
      if (numPairs < numPairsAlloc) {
        ...
        addPair(lagrangianI1, ptI1,
                lagrangianI2, ptI2); /* can @optimize checks */
  ...
  @Override
  public SELM_Interaction_LAMMPS_BONDS clone() {
    SELM_Interaction_LAMMPS_BONDS interaction_copy = new SELM_Interaction_LAMMPS_BONDS();
    ...
    interaction_copy.bondStyle                         = bondStyle.toString();
    interaction_copy.bondTypeID                        = bondTypeID;
    interaction_copy.bondCoeffsStr                     = bondCoeffsStr.toString();
  ...
  public SELM_LagrangianInterface_LAMMPS[] getPairListLagrangian1() {
    ...
    for (int k = 0; k < N; k++) {
      list[k] = (SELM_LagrangianInterface_LAMMPS)pairList_lagrangianI1[k];
    }
    return list;
  }
  ...
  public SELM_LagrangianInterface_LAMMPS[] getPairListLagrangian2() {
    ...
    SELM_LagrangianInterface_LAMMPS list[] = new SELM_LagrangianInterface_LAMMPS[N];
    for (int k = 0; k < N; k++) {
      list[k] = (SELM_LagrangianInterface_LAMMPS)pairList_lagrangianI2[k];
    }
    return list;
  }
  ...
  public void exportToXML(BufferedWriter fid) {
    ...
    try {
      ...
      Atz_XML_Helper.writeXMLData(fid, tagXML_bondTypeID,  getBondTypeID());
      Atz_XML_Helper.writeXMLData(fid, tagXML_bondStyle,   getBondStyle());
      Atz_XML_Helper.writeXMLData(fid, tagXML_bondCoeffs,  getBondCoeffsStr());
  ...
  public void XML_endElement(String uri, String localName, String qName, Atz_XML_SAX_DataHandler sourceHandler) throws SAXException {
    ...
    } else if (qName.equals(tagXML_bondStyle)) {
      bondStyle = xmlAttributes.getValue("value");
    } else if (qName.equals(tagXML_bondTypeID)) {
      bondTypeID = Integer.parseInt(xmlAttributes.getValue("value"));
    } else if (qName.equals(tagXML_bondCoeffs)) {
      bondCoeffsStr = xmlAttributes.getValue("value");

 ...
 */
public class TableModel_Lagrangian_CONTROL_PTS_BASIC1 extends TableModel_Lagrangian {
  ...
  public TableModel_Lagrangian_CONTROL_PTS_BASIC1(SELM_Lagrangian_CONTROL_PTS_BASIC1 lagrangian) {
    setupFirstThirdColumns();

    setFromLagrangianData(lagrangian);
  }
  
  public TableModel_Lagrangian_CONTROL_PTS_BASIC1() {
    setupFirstThirdColumns();

    SELM_Lagrangian_CONTROL_PTS_BASIC1 lagrangian = new SELM_Lagrangian_CONTROL_PTS_BASIC1();
  ...
  public void setFromLagrangianData() {
    ...
    SELM_Lagrangian_CONTROL_PTS_BASIC1 lagrangianData
      = (SELM_Lagrangian_CONTROL_PTS_BASIC1)lagrangian;

 ...
 */
public class JTable_Interaction_LAMMPS_PAIR_COEFF extends JTable_Interaction {

  public JTable_Interaction_LAMMPS_PAIR_COEFF() {
    super();

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_PAIR_COEFF(TableModel dm) {
    super(dm, null, null);

    setupEditorsAndRenderers();
  }

  public JTable_Interaction_LAMMPS_PAIR_COEFF(TableModel dm, TableColumnModel cm, ListSelectionModel sm) {
    super(dm, null, null);

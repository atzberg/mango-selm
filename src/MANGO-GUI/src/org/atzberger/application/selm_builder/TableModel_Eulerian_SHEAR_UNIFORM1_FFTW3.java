 ...
 */
public class TableModel_Eulerian_SHEAR_UNIFORM1_FFTW3 extends TableModel_Eulerian {
  ...
  public TableModel_Eulerian_SHEAR_UNIFORM1_FFTW3(SELM_Eulerian_SHEAR_UNIFORM1_FFTW3 eulerian) {
  ...
  public TableModel_Eulerian_SHEAR_UNIFORM1_FFTW3() {
    setupFirstThirdColumns();

    SELM_Eulerian_SHEAR_UNIFORM1_FFTW3 eulerian = new SELM_Eulerian_SHEAR_UNIFORM1_FFTW3();
    
    setFromEulerianData(eulerian);
  }


  public TableModel_Eulerian_SHEAR_UNIFORM1_FFTW3(Atz_UnitsRef atz_unitsRef_in) {
    setup(null, atz_unitsRef_in);
  }

  public final void setup(SELM_Eulerian_SHEAR_UNIFORM1_FFTW3 eulerian_in, Atz_UnitsRef atz_unitsRef_in) {
    ...
    if (eulerian == null) {
      eulerian = new SELM_Eulerian_SHEAR_UNIFORM1_FFTW3();
    }
  ...
  public void setFromEulerianData() {
    ...
    SELM_Eulerian_SHEAR_UNIFORM1_FFTW3 eulerianData
      = (SELM_Eulerian_SHEAR_UNIFORM1_FFTW3)eulerian;
  ...
  public void setEulerianDataFromModel() {
   ...
   SELM_Eulerian_SHEAR_UNIFORM1_FFTW3 eulerianData
    ...
    eulerianData.setMeshDeltaX((Double) getValueAt(paramIndex_meshDeltaX,colValue));

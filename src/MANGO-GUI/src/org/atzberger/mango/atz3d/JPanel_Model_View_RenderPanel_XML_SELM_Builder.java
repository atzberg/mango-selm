 ...
 */
public class JPanel_Model_View_RenderPanel_XML_SELM_Builder extends JPanel_Model_View_RenderPanel
  ...
  String xmlTag_JPanel_Model_View_RenderPanel = "JPanel_Model_View_RenderPanel";
  
  public JPanel_Model_View_RenderPanel_XML_SELM_Builder(JPanel_Model_View_RenderPanel jPanel_Model_View_RenderPanel_in) {
    setData(jPanel_Model_View_RenderPanel_in);
  }
        
  /* ====================================================================*/
  /* ========================== XML Codes ===============================*/
  public void setData(JPanel_Model_View_RenderPanel jPanel_Model_View_RenderPanel_in) {
    jPanel_Model_View_RenderPanel = jPanel_Model_View_RenderPanel_in;
  }
  
  public void exportToXML(BufferedWriter fid) {
      
      /* -- start tag for this class */
      Atz_XML_Helper.writeXMLStartTag(fid, xmlTag_JPanel_Model_View_RenderPanel);

      /* -- write the camera data */
      jPanel_Model_View_RenderPanel.atz3D_Renderer_SELM.camera.exportToXML(fid);
      
      /* -- end tag for this class */
      Atz_XML_Helper.writeXMLEndTag(fid, xmlTag_JPanel_Model_View_RenderPanel);
  }
  ...
  public void XML_startElement(String uri, String localName, String qName, Attributes attributes, Atz_XML_SAX_DataHandler sourceHandler) throws SAXException {
    ...
    if (qName.equals(xmlTag_JPanel_Model_View_RenderPanel)) {
      
    }
    
    if (qName.equals(jPanel_Model_View_RenderPanel.atz3D_Renderer_SELM.camera.tagXML_Atz3D_Camera)) {
      /* delegate parsing to the camera class */
      sourceHandler.parseCurrentScopeWithDataHandler(jPanel_Model_View_RenderPanel.atz3D_Renderer_SELM.camera);
    }
  ...
  public Object XML_getData() {
    return jPanel_Model_View_RenderPanel; /* WARNING: this is direct object, so not safe for lists */
  }

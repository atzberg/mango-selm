...
/**
 *
 * Handles editing of arrays of simple types, such as Boolean, Integer, Double, or String values.
 *
 * @author Paul J. Atzberger
 *
 * @see <a href="http://www.atzberger.org">http://www.atzberger.org</a>
 */
public class TableEditor_Array_Simple extends AbstractCellEditor
  ...
  public TableEditor_Array_Simple() {
  ...
  void setupDialog() {
    ...
    //dialog = new JDialog_Edit_Array_Simple();
    dialog = new JDialog_Edit_Array_Simple_New(true);

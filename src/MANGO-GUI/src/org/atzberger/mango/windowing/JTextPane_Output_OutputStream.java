 ...
 */
public class JTextPane_Output_OutputStream extends OutputStream {

  OutputStream out;
  JTextPane_Output    jTextPane;

  public JTextPane_Output_OutputStream() {
    //out = System.out; /* set output to standard output */
    out = null;
    jTextPane = null;
  }

  public JTextPane_Output_OutputStream(JTextPane_Output jTextPane_in) {
    //out       = System.out; /* set output to standard output */
    out = null;

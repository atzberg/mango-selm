...
import org.atzberger.mango.jython.Atz_Jython_CaretListener;
...
/**
 *
 * Customised text pane for formatting input and output.
 *
 * @author Paul J. Atzberger
 *
 * @see <a href="http://www.atzberger.org">http://www.atzberger.org</a>
 */
public class JTextPane_Output extends JTextPane implements DocumentListener {
  ...
  public PrintStream stdErr = null;
  ...
  public final static int TEXT_MODE_NULL    = 0;
  public final static int TEXT_MODE_OTHER   = 1;
  public final static int TEXT_MODE_INPUT   = 2;
  public final static int TEXT_MODE_OUTPUT  = 3;
  public final static int TEXT_MODE_ERROR   = 4;
  public final static int TEXT_MODE_MESSAGE = 5;
  ...
  public void setupStyles() {
    ...
    if (flagStylesNotSet) {
      ...
      try {
        ...
        String text = "SELM Builder Version 1.0a : "
...
//      }
  ...
  public void clearAllText() {
    ...
    StyledDocument doc = this.getStyledDocument();
    int I_end = doc.getEndPosition().getOffset() - 1;
    try {
      doc.remove(0, I_end);
    } catch (Exception e) {
      e.printStackTrace();

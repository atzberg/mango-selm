 ...
 * Provides a collection of default physical units with which to work.
 *
 * @author Paul J. Atzberger
 *
 * @see <a href="http://www.atzberger.org">http://www.atzberger.org</a>
 */
public class Atz_UnitsRef_PhysicalUnits extends Atz_UnitsRef implements Atz_XML_Writeable, Atz_XML_SAX_DataHandlerInterface {
  ...
  public Atz_UnitsRef_PhysicalUnits() {
    ...
    unitList[i++] = new Atz_Unit("dimensionless",  "#",    1.0, "nm", Atz_Unit.LENGTH);
    unitList[i++] = new Atz_Unit("nanometer",  "nm",    1.0, "nm", Atz_Unit.LENGTH);
    length_I = i - 1;    
    unitList[i++] = new Atz_Unit("micrometer", "mu_m",  1e3, "nm", Atz_Unit.LENGTH);
    unitList[i++] = new Atz_Unit("millemeter", "mm",    1e6, "nm", Atz_Unit.LENGTH);
    unitList[i++] = new Atz_Unit("meter",      "m",     1e9, "nm", Atz_Unit.LENGTH);

    unitList[i++] = new Atz_Unit("dimensionless", "#",   1.0, "ns", Atz_Unit.TIME);
    unitList[i++] = new Atz_Unit("nanosecond", "ns",    1.0, "ns", Atz_Unit.TIME);
    time_I = i - 1;
    unitList[i++] = new Atz_Unit("second",     "s",     1e9, "s", Atz_Unit.TIME);    

    unitList[i++] = new Atz_Unit("dimensionless",  "#",   1.0,                   "kg", Atz_Unit.MASS);
    unitList[i++] = new Atz_Unit("atom mass unit", "amu", 1.660538728014947e-27, "kg", Atz_Unit.MASS);
    mass_I = i - 1;
    unitList[i++] = new Atz_Unit("kilogram",       "kg",  1.0,                   "kg", Atz_Unit.MASS);
    unitList[i++] = new Atz_Unit("gram",           "g",   1e3,                   "kg", Atz_Unit.MASS);
    
    unitList[i++] = new Atz_Unit("dimensionless", "#",   1.0, "K", Atz_Unit.TEMPERATURE);
    unitList[i++] = new Atz_Unit("kelvin",        "K",   1.0, "K", Atz_Unit.TEMPERATURE);
    temperature_I = i - 1;
  ...
  public Object clone() {
    ...
    Atz_UnitsRef_PhysicalUnits unitsRef = new Atz_UnitsRef_PhysicalUnits();

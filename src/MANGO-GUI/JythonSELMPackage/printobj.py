# Recipe 137951: Dump all the attributes of an object (Python) 
#
# http://code.activestate.com/recipes/137951-dump-all-the-attributes-of-an-object/
#
# Created by Philip Kromer on Fri, 5 Jul 2002 (PSF) 
#
...
# alias the function call dumpObj
def printobj(obj, maxlen=77, lindent=24, maxspew=600):
    dumpObj(obj, maxlen, lindent, maxspew)
    
# alias the function call disp
def disp(obj, maxlen=77, lindent=24, maxspew=600):
    dumpObj(obj, maxlen, lindent, maxspew)    
